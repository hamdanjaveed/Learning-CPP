// 2-3 ask the user to specify padding
...
int main() {
	...
	// ask the user for the number of blank spaces around the greeting vertically
	cout << "How many spaces vertically :";
	int vPad = 0;
	cin >> vPad;
	// the number of blank spaces around the greeting horizontally
	cout << "How many spaces horizontally :";
	int hPad = 0;
	cin >> hPad;
